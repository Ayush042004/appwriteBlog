...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-slate-500 px-4 sm:px-6 lg:px-8 ">
        <div className={`mx-auto max-w-lg bg-gray-200 rounded-xl p-10 border border-black/10`}>
        ...
        <form onSubmit={handleSubmit(login)} className='mt-8 space-y-6'>
            <div className='space-y-5'>
                {/* react form use kare ha toh hrr baar register spread krna hoga jise input yeahi wala aye  */}
                <Input
                label="Email: "
